...
#          this is the only place a break in an unrelated area is caught. Charter's SDK is embedded as a
#          resource into Charter.Server, so a change to sdk/charter-annotate.js can reach Core, Server,
#          Cli and Browser tests alike - none of which any per-task filter selects.
