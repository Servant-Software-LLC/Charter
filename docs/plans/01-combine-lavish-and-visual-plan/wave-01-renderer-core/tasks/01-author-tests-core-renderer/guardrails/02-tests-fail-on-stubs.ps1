# catches: authored CoreRenderer tests that PASS against the NotImplementedException stubs (a
...
if ($LASTEXITCODE -eq 0) {
    Write-Output "The Category=CoreRenderer tests PASSED (or matched none) against the stubs - they are not a real TDD red. They must COMPILE and FAIL against the NotImplementedException stubs."
    exit 1
}
exit 0
